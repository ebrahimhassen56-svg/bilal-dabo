        ...
        if st.button("💾 የዛሬውን ስራ መዝግብና ዝጋ"):
            if not staff_name:
                ...
                if cash_sold_dabo < 0:
                    ...
                    # ከካሽ ሽያጭ መምጣት የነበረበት ብር
                    cash_sold_birr = cash_sold_dabo * DABO_WAGA
                    
                    # 💥 ዋናው ማስተካከያ፦ ከሰራተኛው የሚጠበቀው ብር = (የካሽ ሽያጭ + የተሰበሰበ ዱቤ) - የወጣ ወጪ
                    ...
                    if staff_expense_amount > 0 and staff_expense_item:
                        ...
                        # ለ expenses ሰንጠረዥ Prefer Header እንጨምራለን
                    ...
                    # ሐ) ዛሬ የተመዘገቡትን 'original' ዱቤዎች ወደ 'yedere_dube' ማዛወር (ቀጣይ ቀን ዝግጁ እንዲሆን)
                    for k, v in dube_mezgebiya.items():
